...
class SensitiveDataAnalyzerServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SensitiveAnalyze = channel.unary_unary(
                '/yunanbao.wf.sensitive_data_analyzer.api.v1.SensitiveDataAnalyzerService/SensitiveAnalyze',
...
def add_SensitiveDataAnalyzerServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'yunanbao.wf.sensitive_data_analyzer.api.v1.SensitiveDataAnalyzerService', rpc_method_handlers)
...
class SensitiveDataAnalyzerService(object):
    ...
    def SensitiveAnalyze(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/yunanbao.wf.sensitive_data_analyzer.api.v1.SensitiveDataAnalyzerService/SensitiveAnalyze',
